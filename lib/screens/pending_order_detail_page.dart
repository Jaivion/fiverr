...
class PendingOrderDetailPage extends StatefulWidget {
  // final pendinglistsModel? pendinglists;
  final PendingModel? pendinglists;
  const PendingOrderDetailPage({Key? key, this.pendinglists}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Pending Order Detail', style: theme.textTheme.headline3),
        centerTitle: true,
        leading: IconButton(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl: widget.pendinglists!.user_details[0]
                                ['shop_image']!,
                            width: 50.0,
                            height: 50.0,
                            fit: BoxFit.cover,
                        ...
                        //       image: AssetImage(
                        //         widget.pendinglists!.salon!.image!,
                        //       ),
                        //       fit: BoxFit.cover,
                        //     ),
                        //   ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                  widget.pendinglists!.user_details[0]
                                      ['shop_name'],
                    ...
                    Text(
                        '${widget.pendinglists!.schedule_date} - ${widget.pendinglists!.schedule_time}',
                        style: theme.textTheme.bodyText2),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {},
                        child: Text(
                          (widget.pendinglists!.status! == '0')
                              ? 'Pending'
                              : (widget.pendinglists!.status! == '1')
                                  ? 'Accepted'
                                  : 'Hold',
                          //widget.pendinglists!.status! ,
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('\u{20B9}${widget.pendinglists!.price}',
                            style: theme.textTheme.headline4),
                      ],
                    ),
                  ],
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: widget.pendinglists!.subcats_details
                          .map(
                            (e) => Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                    ...
                    //   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    //   children: [
                    //     Text("${widget.pendinglists!.totalDuration} min",
                    //         style: theme.textTheme.bodyText2),
                    //     Text(widget.pendinglists!.status!,
                    //         style: theme.textTheme.bodyText2),
                    //   ],
                    // ),
                    SizedBox(height: 12.0),
                    Text('Booking Number', style: theme.textTheme.headline5),
                    Text(widget.pendinglists!.order_id!,
                        style: theme.textTheme.bodyText2),
                  ],
                ),
              ),
              widget.pendinglists!.status == "COMPLETED"
                  ? Container(
                      width: size.width,
                      margin: EdgeInsets.all(18.0),
                      decoration: BoxDecoration(
                  ...
                  : widget.pendinglists!.status == "CANCEL"
                      ? Container()
                      : Container(),
            ],
          ),
